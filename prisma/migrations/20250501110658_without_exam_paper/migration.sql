/*
  ...
  - You are about to drop the column `examPaper` on the `Record` table. All the data in the column will be lost.
...
INSERT INTO "new_Record" ("attemptedQuestions", "createdAt", "examName", "examTier", "id", "keyPoints", "learnings", "obtainedMarks", "percentile", "rank", "sectionWise", "testDate", "testLink", "testName", "testPlatform", "totalCorrectMarks", "totalCorrectQuestions", "totalMarks", "totalQuestions", "totalSkippedQuestions", "totalTime", "totalTimeTaken", "totalWrongMarks", "totalWrongQuestions", "updatedAt", "userId") SELECT "attemptedQuestions", "createdAt", "examName", "examTier", "id", "keyPoints", "learnings", "obtainedMarks", "percentile", "rank", "sectionWise", "testDate", "testLink", "testName", "testPlatform", "totalCorrectMarks", "totalCorrectQuestions", "totalMarks", "totalQuestions", "totalSkippedQuestions", "totalTime", "totalTimeTaken", "totalWrongMarks", "totalWrongQuestions", "updatedAt", "userId" FROM "Record";
DROP TABLE "Record";
