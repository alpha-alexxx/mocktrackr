...
export default function SessionListSection({ allSessions }: SessionListSectionProps) {
    ...
    return (
        <Card>
            <CardHeader className='flex w-full flex-col items-center justify-between lg:flex-row'>
                ...
                <div className='flex w-full flex-col items-center justify-center gap-2 md:w-fit'>
                    <Button
                        ...
                        variant='secondary'
                        className='w-full'
                        onClick={() => handleTerminateMultiple('other')}>
                    ...
                    <Button
                        ...
                        variant='destructive'
                        className='w-full'
                        onClick={() => handleTerminateMultiple('all')}>
                        Terminate all sessions
                    </Button>
                </div>
            </CardHeader>
