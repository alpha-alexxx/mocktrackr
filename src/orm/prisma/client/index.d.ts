...
export const ExamTier: {
  TIER_1: 'TIER_1',
  TIER_2: 'TIER_2'
};

export type ExamTier = (typeof ExamTier)[keyof typeof ExamTier]
...
export type ExamTier = $Enums.ExamTier

export const ExamTier: typeof $Enums.ExamTier
...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "user" | "session" | "account" | "verification" | "twoFactor" | "record"
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "email" | "emailVerified" | "image" | "role" | "createdAt" | "updatedAt" | "twoFactorEnabled" | "normalizedEmail", ExtArgs["result"]["user"]>
  ...
  interface UserFieldRefs {
    ...
    readonly normalizedEmail: FieldRef<"User", 'String'>
  }
  ...
  export type RecordAvgAggregateOutputType = {
    ...
    totalSkippedQuestions: number | null
    totalCorrectQuestions: number | null
    totalWrongQuestions: number | null
    totalMarks: number | null
    obtainedMarks: number | null
    totalCorrectMarks: number | null
    totalWrongMarks: number | null
  }
  ...
  export type RecordAvgAggregateInputType = {
    ...
    totalCorrectQuestions?: true
    totalWrongQuestions?: true
    totalMarks?: true
    obtainedMarks?: true
    totalCorrectMarks?: true
    totalWrongMarks?: true
  }
  ...
  export type RecordSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    totalSkippedQuestions?: boolean
    totalCorrectQuestions?: boolean
    totalWrongQuestions?: boolean
    totalMarks?: boolean
    obtainedMarks?: boolean
    totalCorrectMarks?: boolean
    totalWrongMarks?: boolean
    keyPoints?: boolean
    learnings?: boolean
    sectionWise?: boolean
    createdAt?: boolean
  ...
  export type RecordOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "testName" | "testDate" | "examName" | "examCode" | "examTier" | "testPlatform" | "testLink" | "percentile" | "rank" | "totalTimeTaken" | "totalTime" | "totalQuestions" | "attemptedQuestions" | "totalSkippedQuestions" | "totalCorrectQuestions" | "totalWrongQuestions" | "totalMarks" | "obtainedMarks" | "totalCorrectMarks" | "totalWrongMarks" | "keyPoints" | "learnings" | "sectionWise" | "createdAt" | "updatedAt", ExtArgs["result"]["record"]>
  ...
  interface RecordFieldRefs {
    ...
    readonly testName: FieldRef<"Record", 'String'>
    readonly testDate: FieldRef<"Record", 'DateTime'>
    readonly examName: FieldRef<"Record", 'String'>
    readonly examCode: FieldRef<"Record", 'String'>
    readonly examTier: FieldRef<"Record", 'ExamTier'>
    readonly testPlatform: FieldRef<"Record", 'String'>
    readonly testLink: FieldRef<"Record", 'String'>
    readonly percentile: FieldRef<"Record", 'Float'>
    readonly rank: FieldRef<"Record", 'String'>
    readonly totalTimeTaken: FieldRef<"Record", 'String'>
    readonly totalTime: FieldRef<"Record", 'String'>
    readonly totalQuestions: FieldRef<"Record", 'Int'>
    readonly attemptedQuestions: FieldRef<"Record", 'Int'>
    readonly totalSkippedQuestions: FieldRef<"Record", 'Int'>
    readonly totalCorrectQuestions: FieldRef<"Record", 'Int'>
    readonly totalWrongQuestions: FieldRef<"Record", 'Int'>
    readonly totalMarks: FieldRef<"Record", 'Float'>
    readonly obtainedMarks: FieldRef<"Record", 'Float'>
    readonly totalCorrectMarks: FieldRef<"Record", 'Float'>
    readonly totalWrongMarks: FieldRef<"Record", 'Float'>
    readonly keyPoints: FieldRef<"Record", 'String'>
    readonly learnings: FieldRef<"Record", 'String'>
    readonly sectionWise: FieldRef<"Record", 'Json'>
  ...
  /**
   * Reference to a field of type 'ExamTier'
   */
  export type EnumExamTierFieldRefInput<$PrismaModel> = FieldRefInputType<$PrismaModel, 'ExamTier'>
  ...
  export type UserWhereInput = {
    ...
    normalizedEmail?: StringNullableFilter<"User"> | string | null
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    normalizedEmail?: StringNullableWithAggregatesFilter<"User"> | string | null
  }
  ...
  export type RecordWhereInput = {
    ...
    testName?: StringFilter<"Record"> | string
    testDate?: DateTimeFilter<"Record"> | Date | string
    examName?: StringFilter<"Record"> | string
    examCode?: StringFilter<"Record"> | string
    examTier?: EnumExamTierNullableFilter<"Record"> | $Enums.ExamTier | null
    testPlatform?: StringFilter<"Record"> | string
    testLink?: StringNullableFilter<"Record"> | string | null
    percentile?: FloatNullableFilter<"Record"> | number | null
    rank?: StringNullableFilter<"Record"> | string | null
    totalTimeTaken?: StringFilter<"Record"> | string
    totalTime?: StringFilter<"Record"> | string
    totalQuestions?: IntFilter<"Record"> | number
    attemptedQuestions?: IntFilter<"Record"> | number
    totalSkippedQuestions?: IntFilter<"Record"> | number
    totalCorrectQuestions?: IntFilter<"Record"> | number
    totalWrongQuestions?: IntFilter<"Record"> | number
    totalMarks?: FloatFilter<"Record"> | number
    obtainedMarks?: FloatFilter<"Record"> | number
    totalCorrectMarks?: FloatFilter<"Record"> | number
    totalWrongMarks?: FloatFilter<"Record"> | number
    keyPoints?: StringNullableFilter<"Record"> | string | null
    learnings?: StringNullableFilter<"Record"> | string | null
    sectionWise?: JsonFilter<"Record">
  ...
  export type RecordOrderByWithRelationInput = {
    ...
    examName?: SortOrder
    examCode?: SortOrder
    examTier?: SortOrderInput | SortOrder
    testPlatform?: SortOrder
    testLink?: SortOrderInput | SortOrder
    percentile?: SortOrderInput | SortOrder
    rank?: SortOrderInput | SortOrder
    totalTimeTaken?: SortOrder
    totalTime?: SortOrder
    totalQuestions?: SortOrder
    attemptedQuestions?: SortOrder
    totalSkippedQuestions?: SortOrder
    totalCorrectQuestions?: SortOrder
    totalWrongQuestions?: SortOrder
    totalMarks?: SortOrder
    obtainedMarks?: SortOrder
    totalCorrectMarks?: SortOrder
    totalWrongMarks?: SortOrder
    keyPoints?: SortOrderInput | SortOrder
    learnings?: SortOrderInput | SortOrder
    sectionWise?: SortOrder
    createdAt?: SortOrder
    updatedAt?: SortOrder
    user?: UserOrderByWithRelationInput
  }
  ...
  export type RecordScalarWhereWithAggregatesInput = {
    ...
    testName?: StringWithAggregatesFilter<"Record"> | string
    testDate?: DateTimeWithAggregatesFilter<"Record"> | Date | string
    examName?: StringWithAggregatesFilter<"Record"> | string
    examCode?: StringWithAggregatesFilter<"Record"> | string
    examTier?: EnumExamTierNullableWithAggregatesFilter<"Record"> | $Enums.ExamTier | null
    testPlatform?: StringWithAggregatesFilter<"Record"> | string
    testLink?: StringNullableWithAggregatesFilter<"Record"> | string | null
    percentile?: FloatNullableWithAggregatesFilter<"Record"> | number | null
    rank?: StringNullableWithAggregatesFilter<"Record"> | string | null
    totalTimeTaken?: StringWithAggregatesFilter<"Record"> | string
    totalTime?: StringWithAggregatesFilter<"Record"> | string
    totalQuestions?: IntWithAggregatesFilter<"Record"> | number
    attemptedQuestions?: IntWithAggregatesFilter<"Record"> | number
    totalSkippedQuestions?: IntWithAggregatesFilter<"Record"> | number
    totalCorrectQuestions?: IntWithAggregatesFilter<"Record"> | number
    totalWrongQuestions?: IntWithAggregatesFilter<"Record"> | number
    totalMarks?: FloatWithAggregatesFilter<"Record"> | number
    obtainedMarks?: FloatWithAggregatesFilter<"Record"> | number
    totalCorrectMarks?: FloatWithAggregatesFilter<"Record"> | number
    totalWrongMarks?: FloatWithAggregatesFilter<"Record"> | number
    keyPoints?: StringNullableWithAggregatesFilter<"Record"> | string | null
    learnings?: StringNullableWithAggregatesFilter<"Record"> | string | null
    sectionWise?: JsonWithAggregatesFilter<"Record">
  ...
  export type RecordCreateInput = {
    ...
    keyPoints?: string | null
    learnings?: string | null
    sectionWise: JsonNullValueInput | InputJsonValue
    createdAt?: Date | string
    updatedAt?: Date | string
  ...
  export type RecordUpdateInput = {
    ...
    examTier?: NullableEnumExamTierFieldUpdateOperationsInput | $Enums.ExamTier | null
    testPlatform?: StringFieldUpdateOperationsInput | string
    testLink?: NullableStringFieldUpdateOperationsInput | string | null
    percentile?: NullableFloatFieldUpdateOperationsInput | number | null
    rank?: NullableStringFieldUpdateOperationsInput | string | null
    totalTimeTaken?: StringFieldUpdateOperationsInput | string
    totalTime?: StringFieldUpdateOperationsInput | string
    totalQuestions?: IntFieldUpdateOperationsInput | number
    attemptedQuestions?: IntFieldUpdateOperationsInput | number
    totalSkippedQuestions?: IntFieldUpdateOperationsInput | number
    totalCorrectQuestions?: IntFieldUpdateOperationsInput | number
    totalWrongQuestions?: IntFieldUpdateOperationsInput | number
    totalMarks?: FloatFieldUpdateOperationsInput | number
    obtainedMarks?: FloatFieldUpdateOperationsInput | number
    totalCorrectMarks?: FloatFieldUpdateOperationsInput | number
    totalWrongMarks?: FloatFieldUpdateOperationsInput | number
  ...
  export type EnumExamTierNullableFilter<$PrismaModel = never> = {
    equals?: $Enums.ExamTier | EnumExamTierFieldRefInput<$PrismaModel> | null
    in?: $Enums.ExamTier[] | null
    notIn?: $Enums.ExamTier[] | null
    not?: NestedEnumExamTierNullableFilter<$PrismaModel> | $Enums.ExamTier | null
  }
  ...
  export type EnumExamTierNullableWithAggregatesFilter<$PrismaModel = never> = {
    equals?: $Enums.ExamTier | EnumExamTierFieldRefInput<$PrismaModel> | null
    in?: $Enums.ExamTier[] | null
    notIn?: $Enums.ExamTier[] | null
    not?: NestedEnumExamTierNullableWithAggregatesFilter<$PrismaModel> | $Enums.ExamTier | null
    _count?: NestedIntNullableFilter<$PrismaModel>
    _min?: NestedEnumExamTierNullableFilter<$PrismaModel>
    _max?: NestedEnumExamTierNullableFilter<$PrismaModel>
  }
  ...
  export type NullableEnumExamTierFieldUpdateOperationsInput = {
    set?: $Enums.ExamTier | null
  }
  ...
  export type NestedEnumExamTierNullableFilter<$PrismaModel = never> = {
    equals?: $Enums.ExamTier | EnumExamTierFieldRefInput<$PrismaModel> | null
    in?: $Enums.ExamTier[] | null
    notIn?: $Enums.ExamTier[] | null
    not?: NestedEnumExamTierNullableFilter<$PrismaModel> | $Enums.ExamTier | null
  ...
  export type NestedEnumExamTierNullableWithAggregatesFilter<$PrismaModel = never> = {
    equals?: $Enums.ExamTier | EnumExamTierFieldRefInput<$PrismaModel> | null
    in?: $Enums.ExamTier[] | null
    notIn?: $Enums.ExamTier[] | null
    not?: NestedEnumExamTierNullableWithAggregatesFilter<$PrismaModel> | $Enums.ExamTier | null
